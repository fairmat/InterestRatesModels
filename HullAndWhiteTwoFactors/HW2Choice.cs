...
{
    /// <summary>
    /// Implements the IEditableChoice interface for Hull And White Two factors model,
    /// in order to allow to be instanced from the user interface,
    /// and be displayed.
    /// </summary>
    [Extension("/Fairmat/ProcessTypeChoice")]
    public class HW2Choice : IEditableChoice
    {
